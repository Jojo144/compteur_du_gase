# Generated by Django 2.1.7 on 2019-06-13 16:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, verbose_name='nom')),
                ('price', models.DecimalField(decimal_places=2, max_digits=10, verbose_name="prix (en €) à l'unité (kg/L/...)")),
                ...
                ('stock_alert', models.DecimalField(blank=True, decimal_places=2, help_text="Laisser vide pour pas d'alerte", max_digits=10, null=True, verbose_name='Alerte stock')),
                ('comment', models.TextField(blank=True, verbose_name='commentaire')),
        ...
        migrations.AddField(
            model_name='product',
            name='referent',
            field=models.ForeignKey(blank=True, help_text='S\'il le souhaite, le référent reçoit un mail à chaque fois qu\'un produit est approvisionné ou que le stock devient plus bas que le niveau "Alerte stock"', null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.Member', verbose_name='référent'),
        ),
        migrations.AddField(
            model_name='product',
            name='unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.Unit', verbose_name='unité'),
        ),
        migrations.AddField(
