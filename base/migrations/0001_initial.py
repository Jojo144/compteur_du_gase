# Generated by Django 2.2.5 on 2020-01-26 20:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('use_messages', models.BooleanField(default=True, help_text='La fonction messages/actions sert à laisser des messages entre les différentes permanences ou lister des actions à faire.', verbose_name='Utilisation de la fonction messages/actions ?')),
                ...
                ('use_subscription', models.BooleanField(default=True, help_text="La fonction adhésion permet de renseigner la cotisation d'adhésion du foyer.", verbose_name="Utilisation de la fonction cotisation d'adhésion ?")),
                ...
                ('mail_from', models.CharField(default='tata@titi.com', help_text='Exemple : tata@titi.com.', max_length=100, verbose_name="Expéditeur pour l'envoi des mails.")),
                ('mail_username', models.CharField(default='tata', help_text='Exemple : tata.', max_length=100, verbose_name="Nom d'utilisateur pour l'envoi des mails.")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('cash', 'Espèces'), ('cheque', 'Chèque'), ('cancellation', 'Annulation/Correction'), ('repayment', 'Remboursement'), ('ontheflight', 'A la volée')], default='cash', max_length=12, null=True)),
                ('household', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.Household')),
            ],
            options={
                'abstract': False,
